...
_e(function (E, $) {
    ...
    function linkContentHandler (editor, menu, $linkContent) {
        ...
        var $urlInput = $('<input type="text" class="block" placeholder="https://"/>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $howToCopy = $('<a href="https://www.kancloud.cn/wangfupeng/wangeditor2/134973" target="_blank" style="display:inline-block;margin-top:10px;margin-left:10px;color:#999;">如何复制视频链接？</a>');
        var $btnSubmit = $('<button class="right">' + lang.submit + '</button>');
        var $btnCancel = $('<button class="right gray">' + lang.cancel + '</button>');
